...
export default function DailyBibleStoryClient() {
  const { t } = useLanguage()

  return (
    <main className="min-h-screen flex flex-col">
      <section className="daily-bible-story-section flex-1 flex flex-col items-center justify-center px-4 py-12 md:py-24">
        <div className="daily-bible-story-content max-w-4xl mx-auto">
