  ...
  return (
    <div className="min-h-screen py-16 px-4">
      ...
      <section className="mt-16 bg-amber-50 dark:bg-amber-900/20 rounded-lg p-8 max-w-3xl mx-auto">
        <h2 className="text-2xl font-semibold mb-4 text-amber-900 dark:text-amber-100 text-center">{t("terms.title")}</h2>
        <p className="text-lg text-amber-800 dark:text-amber-200 mb-2 text-center">{t("terms.subtitle")}</p>
      </section>
    </div>
  )
} 